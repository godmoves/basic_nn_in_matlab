...
%% 模糊聚类
data=P1;
[center,U,obj_fcn] = fcm(data,5);    %输入数据为行向量
for i=1:R1
    [value,idx]=max(U(:,i));         %输出的U是个列向量
    a1(i)=idx;
end
...
for n=1:csum
    ...
    [va,me4]=min(ecent4);
    [va,me5]=min(ecent5);
    ecnt1(n,:)=P1(me1(1),:);ecent1(me1(1))=mx1;tc1(n)=1;
    ecnt2(n,:)=P1(me2(1),:);ecent2(me2(1))=mx2;tc2(n)=2;
    ecnt3(n,:)=P1(me3(1),:);ecent3(me3(1))=mx3;tc3(n)=3;
    ecnt4(n,:)=P1(me4(1),:);ecent4(me4(1))=mx4;tc4(n)=4;
    ecnt5(n,:)=P1(me5(1),:);ecent5(me5(1))=mx5;tc5(n)=5;
end
